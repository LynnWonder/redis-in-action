...
# TIP 获取分组文章，获取的是根据 score 排名之后的分组文章
...
if __name__ == '__main__':
    ...
    # 发布一篇文章
    # article_id = str(post_article(conn, 'lynn1', 'django', 'https://docs.djangoproject.com'))
    # print("We posted a new article with id:", article_id)
    # print()


    # 将文章添加到分组
    # add_remove_groups(conn, '4', ['python'])


    # 获取分组文章
    # articles = get_group_articles(conn, 'python', 1)
    # print('get python group articles===>')
    # pprint.pprint(articles)
